...
module.exports = (client, guild) => {
    ...
    if (channel.permissionsFor(guild.me).has("EMBED_LINKS")) {
        channel.send({
            embeds: [
                new Discord.MessageEmbed()
                    ...
                    .addField(`\`${config.prefix}add\``, `> *[Invite](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot) the Bot!*`, true)
                    .addField(`\`${config.prefix}support\``, "> *Sends you a Link for the [SUPPORT SERVER](https://discord.gg/MS6TMgRfqB) of the Bot!*", true)
                    ...
                    .addField(`\`${config.prefix}tutorial\``, "> *Gives you a Link to the [Tutorial](https://github.com/OldModz95-YTB/voice-manager-bot-discord)*", true)
                    .addField(`\`${config.prefix}source\``, "> *Gives you a Link to the [Source Code on Github](https://github.com/OldModz95-YTB/voice-manager-bot-discord)*", true)
                    .addField("\u200b", "\u200b")
        ...
        channel.send("**Here is a TUTORIAL :**\nhttps://github.com/OldModz95-YTB/voice-manager-bot-discord")
    } else {
